...
<!-- SIDEBAR MOBILE (OFFCANVAS) KHUSUS UNTUK NETWORK_PORT.PHP -->
...
<!-- SIDEBAR DESKTOP KHUSUS UNTUK NETWORK_PORT.PHP -->
<div class="container-fluid">
  <div class="row">
    ...
    <!-- CONTENT AREA UTAMA (NETWORK PORTS) -->
    <main class="col-md-8 ms-sm-auto col-lg-9 px-md-4 pt-4">
      
      <!-- Header Konten Utama -->
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Dashboard Sistem - Network Ports</h1>
